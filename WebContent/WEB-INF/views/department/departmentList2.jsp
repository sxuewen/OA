...
<html>
  ...
  <body>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabForm">
  	  ...
  	  <tr>
	  	<td colspan="2">
		  <form id="form1" name="form1" method="post" action="department/selectDepartment2">
	...
	<div class="control">
		<button type="button" class="button" onMouseOver="this.className='button_over';" 
		        ...
		        <img src="images/xinjian.png" border='0' align='absmiddle'>&nbsp;添加2</button>&nbsp;
		<button type="button" class="button" onMouseOver="this.className='button_over';" 
	    ...
	    <tr>  
	     <td colspan="9">
	        <c:if test="${page.totalPage!=0}">  
	            ...
	            <a href="department/findDepartmentByPage?parentId=${parentId}&pageNow=1"><u>首页</u></a>  
	        	 	        	 
	       		<c:if test="${page.isHasPre()!=false}">	        		
	            	<a href="department/findDepartmentByPage?parentId=${parentId}&pageNow=${page.pageNow-1}"><u>上一页</u></a>
	        	</c:if>
	        	  
	        	<c:if test="${page.isHasNext()!=false}">	        		
	        		<a href="department/findDepartmentByPage?parentId=${parentId}&pageNow=${page.pageNow+1}"><u>下一页</u></a>            
	        	</c:if>
	        	  		         
		        <a href="department/findDepartmentByPage?parentId=${parentId}&pageNow=${page.totalPage}"><u>尾页</u></a>  
	    ...
	    <tr>  
	     <td colspan="9">
	        <c:if test="${page.totalPage!=0}">  
	            ...
	            <a href="department/findDepartmentByPage2?parentId=${parentId}&dpmName=${dpmName}&pageNow=1" ><u>首页</u></a>  
	        	 	        	 
	       		<c:if test="${page.isHasPre()!=false}">	        		
	            	<a href="department/findDepartmentByPage2?parentId=${parentId}&dpmName=${dpmName}&pageNow=${page.pageNow-1}"><u>上一页</u></a>
	        	</c:if>
	        	  
	        	<c:if test="${page.isHasNext()!=false}">	        		
	        		<a href="department/findDepartmentByPage2?parentId=${parentId}&dpmName=${dpmName}&pageNow=${page.pageNow+1}"><u>下一页</u></a>            
	        	</c:if>
	        	  		         
		        <a href="department/findDepartmentByPage2?parentId=${parentId}&dpmName=${dpmName}&pageNow=${page.totalPage}"><u>尾页</u></a>  
