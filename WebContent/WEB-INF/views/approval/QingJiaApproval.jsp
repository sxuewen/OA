		  			...
		  			<td>
		  				<table>
			     			<tr>
			     				...
			     				<td><input type="text" style="width: 220px;" value="${qingJiaApp.QJType}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">请假起始日期:</td>
			     				<td><input type="text" style="width: 220px;" value="${qingJiaApp.QJStartDay}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">请假结束日期:</td>
			     				<td><input type="text" style="width: 220px;" value="${qingJiaApp.QJEndDay}" disabled></td>
			     			</tr> 
			     			<tr>
			     				<td style="text-align: right;">请假天数:</td>
			     				<td><input type="text" style="width: 220px;" value="${qingJiaApp.QJDays}" disabled></td>
			     			</tr> 				
			     			<tr>
			     				<td style="text-align: right;">请假原因:</td>
			     				<td><textarea rows="5" cols="32" disabled>${qingJiaApp.QJReason}</textarea></td>
			     			</tr>      								
			     		</table>
		  			</td>
