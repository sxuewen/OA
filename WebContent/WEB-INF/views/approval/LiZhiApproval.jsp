		  			...
		  			<td>
		  				<table>
			     			<tr>
			     				...
			     				<td><input type="text" style="width: 220px;" value="${liZhiApp.LZType}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">离职日期:</td>
			     				<td><input type="text" style="width: 220px;" value="${liZhiApp.LZDate}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">离职原因:</td>
			     				<td><textarea rows="5" cols="32" disabled>${liZhiApp.LZReason}</textarea></td>
			     			</tr>   				
			     		</table>
		  			</td>
