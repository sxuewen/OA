		  			...
		  			<td>
		  				<table>
					  		<tr>
			     				...
			     				<td><input type="text" style="width: 220px;" value="${waiChuApp.WCDate}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">外出结束日期:</td>
			     				<td><input type="text" style="width: 220px;" value="${waiChuApp.WCBackDate}" disabled></td>
			     			</tr> 
			     			<tr>
			     				<td style="text-align: right;">外出天数:</td>
			     				<td><input type="text" style="width: 220px;" value="${waiChuApp.WCDays}" disabled></td>
			     			</tr> 				
			     			<tr>
			     				<td style="text-align: right;">外出原因:</td>
			     				<td><textarea rows="5" cols="32" disabled>${waiChuApp.WCReason}</textarea></td>
			     			</tr>      								
			     		</table>
		  			</td>
