		  			...
		  			<td>
				  		<table>
		     				<tr>
		     					...
		     					<td><input type="text" style="width: 220px;" value="${jiaBanApp.JBTip}" disabled></td>
		     				</tr>
		     				<tr>
		     					<td style="text-align: right;">加班起始日期:</td>
		     					<td><input type="text" style="width: 220px;" value="${jiaBanApp.JBStartTime}" disabled></td>
		     				</tr>
		     				<tr>
		     					<td style="text-align: right;">加班结束日期:</td>
		     					<td><input type="text" style="width: 220px;" value="${jiaBanApp.JBEndTime}" disabled></td>
		     				</tr> 	
		     				<tr>
		     					<td style="text-align: right;">加班时长:</td>
		     					<td><input type="text" style="width: 220px;" value="${jiaBanApp.JBTime}" disabled></td>
		     				</tr> 			
		     				<tr>
		     					<td style="text-align: right;">加班原因:</td>
		     					<td><textarea rows="5" cols="32" disabled>${jiaBanApp.JBReason}</textarea></td>
		     				</tr>  
		     				<tr>
		     					<td style="text-align: right;">加班内容:</td>
		     					<td><textarea rows="5" cols="32" disabled>${jiaBanApp.JBContent}</textarea></td>
		     				</tr>   				
		     			</table>
		  			</td>
