		  			...
		  			<td>
		  				<table>     				
			     			<tr>
			     				...
			     				<td><input type="text" style="width: 220px;" value="${tiaoGangApp.TGNewDepartment}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">目标职位:</td>
			     				<td><input type="text" style="width: 220px;" value="${tiaoGangApp.TGNewRole}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">调岗原因:</td>
			     				<td><textarea rows="5" cols="32" disabled>${tiaoGangApp.TGReason}</textarea></td>
			     			</tr>
			     		</table>
		  			</td>
