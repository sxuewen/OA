		  			...
		  			<td>
		  				<table>     				
			     			<tr>
			     				...
			     				<td><input type="text" style="width: 220px;" value="${ruZhiApp.RZrealName}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">性别:</td>
			     				<td><input type="text" style="width: 220px;" value="${ruZhiApp.RZsex}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">家庭住址:</td>
			     				<td><textarea rows="5" cols="32" disabled>${ruZhiApp.RZaddress}</textarea></td>
			     			</tr> 
			     			<tr>
			     				<td style="text-align: right;">出生日期:</td>
			     				<td><input type="text" style="width: 220px;" value="${ruZhiApp.RZbirthday}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">身份证号:</td>
			     				<td><input type="text" style="width: 220px;" value="${ruZhiApp.RZIDcard}" disabled></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">电话号码:</td>
			     				<td><input type="text" style="width: 220px;" value="${ruZhiApp.RZphone}" disabled></td>
			     			</tr>  
			     			<tr>
			     				<td style="text-align: right;">家庭背景:</td>
			     				<td><textarea rows="5" cols="32" disabled>${ruZhiApp.RZfamily}</textarea></td>
			     			</tr>   								
			     			<tr>
			     				<td style="text-align: right;">教育背景:</td>
			     				<td><textarea rows="5" cols="32" disabled>${ruZhiApp.RZeduExperience}</textarea></td>
			     			</tr>   
			     			<tr>
			     				<td style="text-align: right;">工作经历:</td>
			     				<td><textarea rows="5" cols="32" disabled>${ruZhiApp.RZworkExperience}</textarea></td>
			     			</tr>
			     			<tr>
			     				<td style="text-align: right;">目标部门:</td>
			     				<td><input type="text" style="width: 220px;" value="${ruZhiApp.RZdepartmentName}" disabled></td>
			     			</tr>  
			     			<tr>
			     				<td style="text-align: right;">目标职位:</td>
			     				<td><input type="text" style="width: 220px;" value="${ruZhiApp.RZroleName}" disabled></td>
			     			</tr>   
			     		</table>
		  			</td>
