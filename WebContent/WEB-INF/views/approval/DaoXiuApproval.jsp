		  			...
		  			<td>
		  				<table>     				
		     				<tr>
		     					...
		     					<td><input type="text" style="width: 220px;" value="${daoXiuApp.DXStartDate}" disabled></td>
		     				</tr>
		     				<tr>
		     					<td style="text-align: right;">倒休结束日期:</td>
		     					<td><input type="text" style="width: 220px;" value="${daoXiuApp.DXEndDate}" disabled></td>
		     				</tr>
		     				<tr>
		     					<td style="text-align: right;">倒休天数:</td>
		     					<td><input type="text" style="width: 220px;" value="${daoXiuApp.DXDays}" disabled></td>
		     				</tr>
		     				<tr>
		     					<td style="text-align: right;">补班起始日期:</td>
		     					<td><input type="text" style="width: 220px;" value="${daoXiuApp.DXWorkStartDate}" disabled></td>
		     				</tr>
		     				<tr>
		     					<td style="text-align: right;">补班结束日期:</td>
		     					<td><input type="text" style="width: 220px;" value="${daoXiuApp.DXWorkEndDate}" disabled></td>
		     				</tr>
		     				<tr>
		     					<td style="text-align: right;">补班天数:</td>
		     					<td><input type="text" style="width: 220px;" value="${daoXiuApp.DXWorkDays}" disabled></td>
		     				</tr>
		     				<tr>
		     					<td style="text-align: right;">倒休原因:</td>
		     					<td><textarea rows="5" cols="32" disabled>${daoXiuApp.DXReason}</textarea></td>
		     				</tr>    				
		     			</table>
		  			</td>
