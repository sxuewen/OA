...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function checkStaff(){
			...
			var role=$("#role").val();
			var list =new Array();
			list[0]=checksfUserName();
			list[1]=checksfRealName();
			list[2]=checksfCard();
			list[3]=checksfPhone();
			list[4]=checksfAddress();
			list[5]=checksfEmail();
			...
			// 可以使用
			if(tip.innerHTML.length==4 && dpm!=0 && role!=0){
  ...
  <body>
     <form action="staff/saveStaff" method="post">
     	<table style="padding-top: 100px;padding-left: 190px;">
     		<tr>
     			<td style="text-align: right;"><b>员工添加</b></td>
     		</tr>
     		<tr>
     			<td style="text-align: right;">用户名:</td>
     			<td><input type="text" style="width: 220px;" name="sfUserName" id="sfUserName" onblur="checksfUserName()"></td>
     			<td><div id="sfUserName_id"></div></td>
     		</tr>
     		<tr>
     			<td style="text-align: right;">真实姓名:</td>
     			<td><input type="text" style="width: 220px;" name="sfRealName" id="sfRealName" onblur="checksfRealName()"></td>
     			<td><div id="sfRealName_id"></div></td>
     		</tr>
     		<tr>
     		...
     		<tr>
     			...
     			<td><input type="text" style="width: 220px;" name="sfCard" id="sfCard" onblur="checksfCard()"></td>
     			<td><div id="sfCard_id"></div></td>
     		</tr>
     		<tr>
     			<td style="text-align: right;">手机号码:</td>
     			<td><input type="text" style="width: 220px;" name="sfPhone" id="sfPhone" onblur="checksfPhone()"></td>
     			<td><div id="sfPhone_id"></div></td>
     		</tr>
     		<tr>
     			<td style="text-align: right;">联系地址:</td>
     			<td><textarea rows="5" cols="31" name="sfAddress" id="sfAddress" onblur="checksfAddress()"></textarea></td>
     			<td><div id="sfAddress_id"></div></td>
     		</tr>
     		<tr>
     			<td style="text-align: right;">电子邮箱:</td>
     			<td><input type="text" style="width: 220px;" name="sfEmail" id="sfEmail" onblur="checksfEmail()"></td>
