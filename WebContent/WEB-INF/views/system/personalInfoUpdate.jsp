...
<html>
  <head>
	...
	<script type="text/javascript">		
		...
		function checkStaff() {
			if (checksfPhone() == true && checksfAddress() == true && checksfEmail() == true) {
     ...
     <form action="staff/savePersonalInfo" method="post">
     	...
     	<table style="padding-top: 100px;padding-left: 190px;">
     		...
     		<tr>
     			...
     			<td><input type="text" style="width: 220px;" name="dpm" value="${staffInfo.dpmName}" readonly="readonly"></td>
     		</tr>
     		
     		<tr>
     			<td style="text-align: right;">所属职位:</td>
     			<td><input type="text" style="width: 220px;" name="role" value="${staffInfo.roleName}" readonly="readonly"></td>
     		</tr>
