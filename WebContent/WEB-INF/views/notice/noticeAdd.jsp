...
<html>
  ...
  <body>
     <form action="notice/saveNotice" method="post">
     	<input type="hidden" name="sfId" value="${sfId}">
     	<table style="padding-top: 100px;padding-left: 190px;">
     		<tr>
     			<td style="text-align: right;"><b>添加公告</b></td>
     		</tr>
     		
     		<tr>
     			<td style="text-align: right;">公告标题:</td>
     			<td><input type="text" style="width: 220px;" name="notTitle" id="notTitle" onblur="checkNotTitle()"></td>
     			<td><div id="notTitle_id"></div></td>
     		</tr>
     		<tr>
     			<td style="text-align: right;">公告内容:</td>
     			<td><textarea rows="5" cols="31" name="notContent" id="notContent" onblur="checkNotContent()"></textarea></td>
     			<td><div id="notContent_id"></div></td>
     		</tr>
     		<tr>
     			<td style="text-align: right;">发布人:</td>
     			<td><input type="text" style="width: 220px;" name="adminName" id="adminName" value="${adminName}" readonly></td>
     		</tr>
